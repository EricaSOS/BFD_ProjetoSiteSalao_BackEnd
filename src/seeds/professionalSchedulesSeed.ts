...
export async function seedProfessionalSchedules() {
  ...
  if (ricardo) {
    schedules.push(
      [ricardo.id, 1, "08:00", "12:00", 1],
      [ricardo.id, 1, "14:00", "18:00", 1],
      [ricardo.id, 2, "08:00", "12:00", 1],
      [ricardo.id, 2, "14:00", "18:00", 1],
      [ricardo.id, 3, "08:00", "12:00", 1],
      [ricardo.id, 3, "14:00", "18:00", 1],
      [ricardo.id, 4, "08:00", "12:00", 1],
      [ricardo.id, 4, "14:00", "18:00", 1],
      [ricardo.id, 5, "08:00", "12:00", 1],
  ...
  if (ana) {
    schedules.push(
      [ana.id, 2, "09:00", "12:00", 1],
      [ana.id, 2, "13:00", "18:00", 1],
      [ana.id, 3, "09:00", "12:00", 1],
      [ana.id, 3, "13:00", "18:00", 1],
      [ana.id, 4, "09:00", "12:00", 1],
      [ana.id, 4, "13:00", "18:00", 1],
      [ana.id, 5, "09:00", "12:00", 1],
      [ana.id, 5, "13:00", "18:00", 1],
      [ana.id, 6, "09:00", "12:00", 1],
  ...
  if (juliana) {
    schedules.push(
      [juliana.id, 1, "08:00", "12:00", 1],
      [juliana.id, 1, "13:00", "16:00", 1],
      [juliana.id, 2, "08:00", "12:00", 1],
      [juliana.id, 2, "13:00", "16:00", 1],
      [juliana.id, 3, "08:00", "12:00", 1],
      [juliana.id, 3, "13:00", "16:00", 1],
      [juliana.id, 4, "08:00", "12:00", 1],
      [juliana.id, 4, "13:00", "16:00", 1],
      [juliana.id, 5, "08:00", "12:00", 1],
